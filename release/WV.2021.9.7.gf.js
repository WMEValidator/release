	...
	_translations =
		{
		  'EN':
			  {
				...
				'noaccess.text': '<b>Sorry,</b><br>You cannot use WME Validator over here.<br>Please check <a target=\'_blank\' href=\'' + PFX_FORUM + FORUM_HOME +
					'\'>the forum thread</a><br>for more information.',
				...
				'171.params':
					{
					  ...
					  'solutionEN':
						  'Check upper/lower case, a space before/after the abbreviation and the accordance with the abbreviation table. Remove any comma (,), backslash (\\), or semicolon (;)'
					}
			  },
		  ...
		  'PL':
			  {
				...
				'161.enabled': true,
				'161.params':
					{'titleEN': 'DKnum in street name', 'problemEN': 'The street name contains DKnum', 'solutionEN': 'Remove the DK prefix from the street name', 'regexp': '/DK\\-?[0-9]+/i'},
				...
				'162.enabled': true,
				'162.params':
					{'titleEN': 'DWnum in street name', 'problemEN': 'The street name contains DWnum', 'solutionEN': 'Remove the DW prefix from the street name', 'regexp': '/DW\\-?[0-9]+/i'},
				...
				'169.params': {
				  ...
				  'solutionEN':
					  'In the address properties check the \'None\' box next to the street name, click \'Apply\' and then add \'Junction\' landmark to name the roundabout or remove word \'ulica\'',
		  ...
		  'NL':
			  {
				...
				'255.solution':
					'In Nederland gebruiken we +31 AA BBBBBBBB, of +31 AAA BBBBBBB voor vaste lijnen en +31 6 CBBBBBBB voor mobiele nummers. Corrigeer het telefoon nummer volgens die formaten',
				'255.solutionLink': 'P:Netherlands/Places#More_Info_tab',
				'255.params': {'regexp.title': '{string} regular expression to match a correct phone number', 'regexp': '/\\+31(?: \\d{2} \\d{8}| \\d{3} \\d{6}|\\s6 \\d{8})/'},
		  ...
		  'ES': {
			...
			'133.params':
				{'titleEN': 'No lock on Ramp', 'problemEN': 'The Ramp segment should be locked to Lvl 3', 'solutionEN': 'Lock the segment', 'template': '${type}:${lock}', 'regexp': '/^4:[^3]/'},
			...
			'200.solution':
				'Haz clic en el giro indicado con un signo de interrogación color púrpura para confirmarlo. Nota: es posible que debas hacer el segmento bidireccional para ver todos los giros',
		  ...
		  'BE': {
			...
			'160.params':
				{'solutionEN': 'Rename the Freeway segment to a \'Anum\' or \'Anum - Enum\' or \'Anum > Dir1 / Dir2\'', 'regexp': '!/^(A|B|E)[0-9]+( - (A|E)[0-9]+)*( > [^\\/]+( \\/ [^\\/]+)*)?$/'},
			'163.enabled': true,
...
function F_LOGIN() {
  ...
  WSM.events.on({'selectionchanged': ForceHLAllObjects});
...
function F_LOGOUT() {
  ...
  WSM.events.un({'selectionchanged': ForceHLAllObjects});
